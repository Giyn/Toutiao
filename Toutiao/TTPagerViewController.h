...
typedef void(^OnPageLeave)(NSInteger currentIndex, __weak UIViewController *_Nullable weakVC);
typedef void(^OnPageEnter)(NSInteger currentIndex, __weak UIViewController *_Nullable weakVC);
